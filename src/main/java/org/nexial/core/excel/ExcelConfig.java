...
public class ExcelConfig {
	...
	public static final ExcelAddress ADDR_PLAN_HEADER_SEQUENCE2 = new ExcelAddress("F1:I1");
	...
	public static final String PLAN_HEADER_JIRA_OVERRIDE = "jira override";
	public static final String PLAN_HEADER_ZEPHYR_OVERRIDE = "zephyr override";
	...
	public static final List<String> PLAN_HEADER_SEQUENCE = Arrays.asList(PLAN_HEADER_SUMMARY,
	                                                                      PLAN_HEADER_AUTHOR,
	                                                                      PLAN_HEADER_JIRA_OVERRIDE,
	                                                                      PLAN_HEADER_ZEPHYR_OVERRIDE,
	                                                                      PLAN_HEADER_NOTIFICATION_OVERRIDE);
	...
	public static final String HEADER_SCENARIO_INFO_JIRA = "jira";
	public static final String HEADER_SCENARIO_INFO_ZEPHYR = "zephyr";
	...
	public static final List<String> HEADER_SCENARIO_INFO = Arrays.asList(HEADER_SCENARIO_INFO_DESCRIPTION,
	                                                                      ...
	                                                                      HEADER_SCENARIO_INFO_JIRA,
	                                                                      HEADER_SCENARIO_INFO_ZEPHYR,
