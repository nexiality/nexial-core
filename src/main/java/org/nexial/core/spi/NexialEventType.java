...
public enum NexialEventType {
    ...
    PlanStart, PlanEnd,
    SubPlanStart, SubPlanEnd,
    ScriptParsed, DataFileParsed, ProjectPropertiesParsed,
    ScriptStart, ScriptEnd,
    IterationStart, IterationEnd,
    ScenarioStart, ScenarioEnd,
    ActivityStart, ActivityEnd,
    RepeatUntilStart, RepeatUntilEnd,
    StepStart, StepSucceed, StepFailed, StepSkipped, StepPaused,
