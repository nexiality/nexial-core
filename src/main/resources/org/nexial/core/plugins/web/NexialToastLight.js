...
window.nexial.ToastLight = (msg, duration) => {
	...
	el.setAttribute('style', 'position: fixed; z-index: 999; bottom: ' + newToastBottom + ';' +
													 ...
													 'color: rgba(40, 40, 40, 0.95); text-shadow: 1px 1px 2px rgb(150 150 150 / 75%);' +
	...
	el.innerHTML = msg +
								 ...
								 'text-align: right; text-shadow: 2px 3px 2px rgb(250 250 250 / 85%); color: rgba(80,80,80,0.98);' +
