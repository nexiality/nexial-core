...
import org.nexial.core.utils.JsonHelperTest.Company;
import org.nexial.core.utils.JsonHelperTest.Person;
...
public class JsonUtilsTest {
	...
	public void testToJSONObject() {
		...
		Assert.assertEquals(json.optJSONArray("jurisId"), null);
	...
	public void testFilterToList() {
		...
		Assert.assertTrue(integers.get(0) == 5);
		...
		Assert.assertTrue(doubles.get(0) == 6.1);
		...
		Assert.assertTrue(numbers.get(0).intValue() == 5);
		Assert.assertTrue(numbers.get(1).doubleValue() == 6.1);
		...
		Assert.assertTrue(jsonObjects.get(1).optJSONArray("c").length() == 2);
	...
	public void testToJSONObjectMap() {
		...
		map.put("number", new Integer(154));
		map.put("array", new Object[]{Boolean.TRUE, new Double(15.324), "another test", new Byte((byte) 5)});
